...
def send_order_success_mail(order_id:str, to_email:str):
    ...
    '''
        ...
        <p style="color: #333; line-height: 1.6;">If you have any questions or concerns, feel free to reply on this email. We're here to help!</p>
...
def send_order_out_for_delivery_mail(order_id:str, to_email:str):
    try:
        recipient_email = to_email
        ...
        message['To'] = recipient_email
        Bcc = ['support@sweetmist.in']
        message['Subject'] = '🛍️ Your Order is out for delivery! 🎉'
    ...
    <body style="font-family: Arial, sans-serif; background-color: #fff; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 20px auto; padding: 20px; background-color: #fff; border-radius: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
        <h1 style="color: #6a2249; text-align: center;">&#127881; Order Out for Delivery &#127881;</h1>
        <p style="color: #333; line-height: 1.6;">Hey there!</p>
        <p style="color: #333; line-height: 1.6;">We're thrilled to let you know that your order has been successfully out for delivery and will reach to you by 3 working days.</p>
        <p style="color: #333; line-height: 1.6;">Here's a summary of your order:</p>
...
def send_order_delivered_mail(order_id:str, to_email:str):
    try:
        recipient_email = to_email
        ...
        message['To'] = recipient_email
        Bcc = ['support@sweetmist.in']
        message['Subject'] = '🛍️ Your Order is delivered! 🎉'
    ...
    <body style="font-family: Arial, sans-serif; background-color: #fff; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 20px auto; padding: 20px; background-color: #fff; border-radius: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
        <h1 style="color: #6a2249; text-align: center;">&#127881; Order Delivered &#127881;</h1>
        <p style="color: #333; line-height: 1.6;">Hey there!</p>
        <p style="color: #333; line-height: 1.6;">We're thrilled to let you know that your order has been successfully delivered.</p>
        <p style="color: #333; line-height: 1.6;">Here's a summary of your order:</p>
    ...
    '''
        ...
        body_3 = f'''<!-- If there are multiple orders, you can repeat the above list for each order -->
        <p style="color: #333; line-height: 1.6;">Need invoice of your order? No problem! Just click the button below:</p>
        <p style="color: #333; line-height: 1.6; text-align: center; margin-top: 20px;"><a href="{DOMAIN}/order_detail/invoice?order_id={order_id}" style="display: inline-block; padding: 10px 20px; background-color: #6a2249; color: #ffffff; text-decoration: none; border-radius: 5px;">Invoice</a></p>
        <p style="color: #333; line-height: 1.6;">If you have any questions or concerns, feel free to reply on this email. We're here to help!</p>
        <p style="color: #333; line-height: 1.6;">Thank you for choosing us!</p>
        <p style="color: #6a2249; line-height: 1.6;"><b>Best regards,<br>Sweet Mist</b></p>
    </div>
